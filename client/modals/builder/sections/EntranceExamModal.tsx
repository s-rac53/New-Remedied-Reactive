...
import { EntranceExam, SectionPath } from '@reactive-resume/schema';
import Joi from 'joi';
...
type FormData = EntranceExam;

const path: SectionPath = 'sections.entranceexams';
...
const EntranceExamModal: React.FC = () => {
